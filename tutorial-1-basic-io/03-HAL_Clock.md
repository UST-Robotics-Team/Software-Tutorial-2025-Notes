...
- When BTN is held longer than 5s, toggle LED1 every 100ms for 1s, and change the interval from 100ms to 300ms for 2s, then back to 100ms for 1s, and continue until the button is released. **(@2)**
