...
- Make your code, such that BTN1 does all of the following at the same time:
  ...
  - After BTN is held longer than 10s, toggle LED1 every 200ms for 4s, and change the interval from 400ms to 1000ms for 10s, then back to 200ms for 4s, and continue until the button is released. **(@1)**
